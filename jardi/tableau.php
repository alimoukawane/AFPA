...
<body>
    ...
    <?php include 'header/header.php'; 
     ...
     require "connexion_bdd.php"; //  biblio de fonctions
    ...
    <br>
    <a href="ajout.php"><button>Ajouter un article</button></a>
     
    <p id="tableau"></p>
    <div class="table-responsive"> 
      <table class="table table-hover table-bordered w-100 w-sm-70"> 
          <thead>
